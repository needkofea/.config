...
VOLUME_ICON="$_DIR/MaterialSymbolsVolumeUpRounded.svg"


if [[ ${VOLUME} -lt 50 ]]; then
    VOLUME_ICON="$_DIR/MaterialSymbolsVolumeDownRounded.svg"
fi

if [[ $(pamixer --get-mute) == "true" ]]; then
    VOLUME_ICON="$_DIR/MaterialSymbolsNoSoundRounded.svg"
fi
